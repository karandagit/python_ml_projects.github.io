...
IFontDisp = Font
__all__ = [ 'Font', 'FONTSIZE', 'IFontDisp', 'LoadPictureConstants',
           'OLE_COLOR', 'OLE_YSIZE_CONTAINER', 'FONTSTRIKETHROUGH',
           'OLE_HANDLE', 'OLE_XPOS_HIMETRIC', 'Default',
           'OLE_YSIZE_PIXELS', 'Monochrome', 'OLE_YPOS_HIMETRIC',
           'Color', 'OLE_YPOS_PIXELS', 'FontEvents',
           'OLE_OPTEXCLUSIVE', 'StdPicture', 'OLE_XSIZE_PIXELS',
           'OLE_TRISTATE', 'StdFont', 'IFont', 'Picture', 'Checked',
           'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_PIXELS', 'OLE_YPOS_CONTAINER', 'Unchecked',
           'Gray', 'OLE_ENABLEDEFAULTBOOL', 'IPictureDisp',
           'OLE_YSIZE_HIMETRIC', 'FONTITALIC', 'FONTBOLD',
           'IFontEventsDisp', 'VgaColor', 'IPicture', 'FONTNAME',
           'OLE_XPOS_CONTAINER', 'OLE_CANCELBOOL', 'FONTUNDERSCORE']
